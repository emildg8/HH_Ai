...
| 03.07.2026 | HT6.4/QA | Anastasia regen через `run-devops-regenerate-letters` (DS Lab claude-haiku), не прямой regenerate | package.json devops:regenerate-letters:anastasia |
