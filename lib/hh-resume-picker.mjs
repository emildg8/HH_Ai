 ...
 *
 * devops↔infra остаются совместимы (семья) — sticky DevOps при ideal infra не режем здесь (P2).
 *
...
export function questionnaireStepResumeBlocksSubmit(opts = {}) {
  ...
  const titleOk =
    ...
    (ideal === 'infra' && /системн/i.test(curTitle) && !/поддержк|руководитель/i.test(curTitle)) ||
