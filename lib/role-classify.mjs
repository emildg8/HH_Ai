...
export function titleLooksNonItRole(title) {
  ...
  return (
    /продавец|кассир|мерчендайз|охранник|водитель|курьер|официант|бариста|уборщик|уборщиц/i.test(t) ||
