 ...
 *   log?: (msg: string) => void,
 * }} opts
 * @returns {Promise<{ submitted: boolean, label?: string, letterInForm?: boolean, resumeAttached?: boolean, profileResume?: string, profileResumeHash?: string, questionnaire?: object }>}
 */
export async function completeVacancyResponseForm(page, opts = {}) {
  ...
  for (let step = 0; step < maxSteps; step++) {
    ...
    if (submit && !pendingLetter && !pendingResume) {
      ...
      progressed = true;
      await page.waitForTimeout(isFastMode() ? 600 : 900);
