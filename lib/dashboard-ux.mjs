...
/** Блоки боковой панели (id → настройки) */
export const SIDEBAR_PANELS = {
  ...
  quickSync: { id: 'quickSync', label: 'Быстрые действия', defaultVisible: true, expertOnly: false },
  filters: { id: 'filters', label: 'Фильтры списка', defaultVisible: true, expertOnly: false },
  serviceLink: { id: 'serviceLink', label: 'Сервис (кнопка)', defaultVisible: true, expertOnly: false },
