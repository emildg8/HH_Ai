...
export function sanitizeCoverLetterRuTerms(text) {
  ...
  // Сначала pet-проект*, иначе «pet-проектах» → «-проектах» (баг 20.07 ДОМ.РФ)
  t = t.replace(/\bpet-проект\w*/gi, 'собственных проектах');
  t = t.replace(/\bpet\s+проект\w*/gi, 'собственных проектах');
  ...
  t = t.replace(/\s+-\s*проект/gi, ' собственных проект');
  t = t.replace(
