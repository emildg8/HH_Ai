...
import { stableVacancyRecordId, vacancyIdFromRecord } from './vacancy-record-resolve.mjs';
...
export function scanOffersAndSlots(records) {
  ...
  for (const rec of list) {
    ...
    const recordId = stableVacancyRecordId(rec);
    if (!recordId) continue;
    items.push({
      id: recordId,
      vacancyId: vacancyIdFromRecord(rec) || undefined,
      title: rec.title,
      company: rec.company,
