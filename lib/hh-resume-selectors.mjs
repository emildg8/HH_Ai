...
/** Кнопки «Поднять в поиске» / «Поднять» (все резюме) на списке резюме */
export const RAISE_IN_SEARCH_BUTTON = [
  'button:has-text("Поднять в поиске")',
  'a:has-text("Поднять в поиске")',
];

export const RAISE_ALL_RESUMES_BUTTON = [
  'button:has-text("Поднять"):not(:has-text("автоматически"))',
];
